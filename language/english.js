...
module.exports = {
	...
	lang: {
		perms: `${e.error} You do not have permission \`MANAGE_MESSAGES\`, you can create a rank for implementation named \`Giveaway Manger\` and addd to a user for \`start & create & edit ...\` giveaways or set specify role from your guild By using the following command \`${prefix}setrole [on / off] {your role}\`!.`,
		msg: `${e.error} please enter a vaild language (\`ar\`, \`en\`, \`ru\`, \`ua\`, \`tr\`)`,
	},
	...
	invite: {
		...
		web: `${e.link} RustyManager Website`,
		inv: `${e.add} Invite RustyManager Bot`,
		vote: `${e.vote} Vote For RustyManager Bot`,
		sup: `${e.supp} Join The Support Server`
	},

	help: {
		title: "Help Documents Overview:",
		disc: "● Here you can find all `RustyManager Commands`",
	...
	stats: {
		title: "RustyManager Information:",
	...
	blacklist: {
		blacklist: "🔒 **You cannot use `RustyManager commands` because you are in the `Blacklist!!`**"
	}
};