...
module.exports = {
	...
	lang: {
		perms: `${e.error} ليس لديك إذن \`MANAGE_MESSAGES\` يمكنك إنشاء رتبة للتنفيذ باسم \`Giveaway Manger\` واعطائها للشخص اللذي يريد التعديل او يمكنك تحديد رتبة من سيرفرك عبر استخدام الامر التالي \`${prefix}setrole [on/off] {role name}\``,
		msg: `${e.error} الرجاء ادخال لغة صالحة مثال: (\`ar\`, \`en\`, \`ru\`, \`ua\`, \`tr\`)`,
	},
	...
	invite: {
		...
		web: `${e.link} رابط موقع RustyManager Bot`,
		inv: `${e.add} رابط اضافة RustyManager Bot`,
		vote: `${e.vote} التصويت ل RustyManager Bot`,
		sup: `${e.supp} سيرفر الدعم الفني`
	},

	help: {
		title: "Help Documents Overview:",
		disc: "● هنا يمكنك ان تجد جميع `RustyManager Commands`",
	...
	blacklist: {
		blacklist: "🔒 | **لا يمكنك استخدام`RustyManager Commands` لانك ممنوع بسبب مخالفتك قوانين البوت"
	}
};