...
module.exports = {
	...
	lang: {
		perms: `${e.error} У Вас нет права \`MANAGE_MESSAGES\`, Вы можете создать роль с названием \`Giveaway Manger\` и дать доступ к командам \`start & create & edit ...\` или установите свою роль, используя команду \`${prefix}setrole [on / off] {Ваша роль}\`!`,
		msg: `${e.error} Введите корректный язык! Список доступных языков - (\`ar\`, \`en\`, \`ru\`, \`ua\`, \`tr\`)`,
	},
	...
	help: {
		...
		disc: "● Здесь Вы можете найти все команды для `RustyManager` бота",
	...
	blacklist: {
		blacklist: "🔒 **Вы не можете использовать `RustyManager команды`, т.к Ваш сервер был добавлён в `чёрный список`!**"
	}
};
