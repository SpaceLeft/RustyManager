...
module.exports = {
	...
	edit: {
		...
		timepr: (numberOfSecondsMax)=> `${e.success} Нагорода розіграша буде оновлена через \`${numberOfSecondsMax}\` секунд.`,
		timwi: (numberOfSecondsMax)=> `${e.success} Кіль-сть переможців буде оновлено через \`${numberOfSecondsMax}\` секунд.`,
		err: `${e.error} Помилка при отриманні даних розіграша: `,
	...
	invite: {
		...
		web: `${e.link} RustyManager веб-сейт`,
	...
	help: {
		...
		disc: "● Тут Ви можете знайти всі команди для `RustyManager` бота",
	...
	myprefix: {
		hello: `${e.info} | Привіт `,
		prefixis: (guildData) => ` мій префікс на цьому сервері: \`${guildData.prefix}\`. Використовуйте команду \`${guildData.prefix}help\`, щоб отримати список всіх команд!`,
	},
	
	blacklist: {
		blacklist: "🔒 **Ви не можете використовувати `RustyManager команди`, так як Ваш сервер був доданий до `чорного списку`!**"
	}
};
